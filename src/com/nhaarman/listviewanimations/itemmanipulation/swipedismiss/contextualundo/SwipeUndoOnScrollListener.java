 ...
 */
public class SwipeUndoOnScrollListener implements AbsListView.OnScrollListener {

    private ContextualUndoListViewTouchListener mTouchListener;

    public void setTouchListener(final ContextualUndoListViewTouchListener touchListener) {
