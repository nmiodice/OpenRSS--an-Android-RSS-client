...
public class NavDrawerAdapter extends ArrayAdapter<NavDrawerItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if ( menuItem.getType() == NavMenuItem.ITEM_TYPE ) {
            ...
            /* NavMenuSection does not have a getIsSelected method, so a cast is necessary */
            NavMenuItem _mItem = (NavMenuItem)menuItem;
            if (_mItem.getIsSelected() == true) {
            	view.findViewById(R.id.navmenuitem_icon).setSelected(true);
            	Log.i("", "Selected!");
            } else {
            	view.findViewById(R.id.navmenuitem_icon).setSelected(false);
            }
        }
        else {
